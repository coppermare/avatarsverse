...
import logo from "@/app/avatarsverse_logo.png";

export function Header() {
  return (
    <header className="sticky top-0 z-50 w-full bg-background/95 py-3 backdrop-blur supports-[backdrop-filter]:bg-background/80">
